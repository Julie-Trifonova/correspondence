...
import {change, Field, WrappedFieldMetaProps, WrappedFieldProps} from "redux-form";
...
function createField<FormKeysType extends string>(
  ...
  updateFormData: (field: string, value: documentType) =>
      () => (form: string, field: string, value: documentType, touch?: boolean, persistentSubmitErrors?: boolean) => () => void
) {
