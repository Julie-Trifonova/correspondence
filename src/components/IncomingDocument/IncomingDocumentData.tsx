                ...
                <Card variant="outlined" sx={{
                    ...
                    <CardContent>
                        ...
                        <div className={s.oneLine}>
                            ...
                            {document.name
                            ? <Typography variant="h5" component="span" sx={typographyDataStyle}>
                                    {document.name}
                                </Typography>
                            : unspecified()}
                        </div>
                        <div className={s.oneLine}>
                            {document.documentIsReading
                                ? <Typography component="span" sx={typographyDataStyle}>
                                    Прочитано <MarkEmailReadIcon fontSize='small'
                                                                 sx={{
                                                                    marginBottom: '-4px',
                                                                 }}
                                />
                                </Typography>
                                : <Typography component="span" sx={typographyDataStyle} style={{color: '#bd3131'}}>
                                    Не прочитано <MarkEmailUnreadIcon fontSize='small'
                                                                      sx={{
                                                                          marginBottom: '-4px',
                                                                      }}/>
                                </Typography>
                        ...
                        <div className={s.oneLine}>
                            <Typography sx={typographyTypeStyle}
                                        component="span"
